              ...
              <form class="form-horizontal" method="post" action="<?php echo base_url('petugas/update') ?>">
                <div class="card-body">   
                    <div class="form-group row">
                      ...
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="id" value="<?php echo $value->id_petugas;?>" disabled>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-8">
                        <input type="text" class="form-control" value="<?php echo $value->username;?>" name="username" required>
